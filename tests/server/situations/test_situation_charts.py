...
from policy_engine.situations.charts import household_waterfall_chart, budget_chart, mtr_chart
import pytest
import itertools
...
raise_basic_rate = reforms.parametric.set_parameter("tax.income_tax.rates.uk[0].rate", 0.21)
...
@pytest.mark.parametrize("situation,reform", itertools.product(situation_examples, reform_examples))
def test_household_waterfall_chart(situation, reform):
	...
	household_waterfall_chart((reform,), ["Reform"], situation, baseline, reformed)
