from policy_engine.populations.charts import decile_chart, poverty_chart, population_waterfall_chart
...
def test_population_waterfall_chart(reform):
	population_waterfall_chart((reform,), ["Reform"], baseline, Microsimulation(reform))
